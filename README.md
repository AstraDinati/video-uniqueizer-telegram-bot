...
3. Создаём виртуальное окружение (venv) для изоляции зависимостей. Если у вас нет виртуального окружения, вы можете установить его следующим образом:
...
4. Активируем виртуальное окружение (в зависимости от вашей операционной системы):
    - Windows:
